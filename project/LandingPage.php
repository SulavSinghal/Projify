...
<header class="bg-white shadow">
        <div class="container mx-auto p-4 flex justify-between items-center">
            ...
            <div class = "flex items-center space-x-10"> 
                <h2 class = "font-semibold">Welcome, <?php echo $name ?></h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="bg-white p-6 rounded-lg shadow mb-8">
            <h2 class="text-lg font-semibold mb-4">Filter Projects by Skills</h2>
            ...
            <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Search</button>
        </div>
    ...
    foreach ($project_query_run as $projectIdeas) {
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-2 mb-4">
                <span class="bg-gray-200 px-2 py-1 rounded text-sm"><?= htmlspecialchars($projectIdeas['skills_required']); ?></span>
            </div>
